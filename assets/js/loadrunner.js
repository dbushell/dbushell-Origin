...
(function(win, doc)
{
    ...
    // detect Android
    if (ua.match(/Android/) && ua.match(/AppleWebKit/) && !ua.match(/Chrome/)) {
        de.className += ' android';
    }
    ...
    // detect Opera Mini
    if (ua.indexOf('Opera Mini') >= 0 && Object.prototype.toString.call(window.operamini) === '[object OperaMini]') {
        de.className += ' operaMini';
    }
